...
############################################################################################
channel.set_configuration_parameters(time_scale=1.0, height=512, width=768)  # 10倍速渲染
...
############################ step3.加载模型 ###############################
if not os.path.exists('model_ma_linear'): os.mkdir('model_ma_linear')
file_path = "./model_ma_linear/"
